...
import com.mycompany.cafe.main.dao.CategoryDao;
import com.mycompany.cafe.main.service.CategoryService;
			...
			if (jwtFilter.isAdmin()) {
				if (validateCategoryMap(requestMap, true)) {
					...
					if (!optional.isEmpty()) {
						...
						return CafeUtils.getResponseEntity("Category id doe not exist.", HttpStatus.OK);
					}
